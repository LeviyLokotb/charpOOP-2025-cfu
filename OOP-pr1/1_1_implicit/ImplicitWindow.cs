...
public partial class ImplicitWindow : Window
{
    ...
    public ImplicitWindow() : base()
    {
        ...
        //
        MyTitle.Append(Label.New("Неявные преобразования типов в C#"));
        // Кнопка
    ...
    private void OnCheckButtonClicked(Button sender, EventArgs e)
    {
        ...
        Log(ImplicitConv.ImplicitConvDemo(selected1, selected2));
        InProcessing = false;
    }
